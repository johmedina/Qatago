  ...
  render(){
    return(
      <View style={{marginLeft: 10}}>
        ...
        <Text style={styles.subtitle}> INDOOR ACTIVITIES </Text>
        ...
        <View style = {{flexDirection: 'row', justifyContent: 'center'}}>
          ...
          <TouchableOpacity
            ...
            <Text style={styles.text}> Theme Parks </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style = {{flexDirection: 'row', justifyContent: 'center'}}>
          ...
          <TouchableOpacity
            ...
            <Text style={styles.text}>  Spas </Text>
          </TouchableOpacity>
        ...
        <View style = {{flexDirection: 'row', justifyContent: 'center'}}>
          ...
          <TouchableOpacity
                style={[styles.button, this.state.bcvolunt && {backgroundColor: '#CF9799' }]}
                onPress={()=>this.setState({bcvolunt: !(this.state.bcvolunt) })}>
          ...
          <View style = {{flexDirection: 'row'}}>
            <TouchableOpacity style = {styles.skipButton} onPress = {() => this.props.navigation.navigate('Outdoor')} >
              <Text style = {{marginTop: 60, fontSize: 15, color:'#7C3538',}}> 1/3 </Text>
